...
export class TBTCDepositToken extends ethereum.SmartContract {
  static bind(address: Address): TBTCDepositToken {
    return new TBTCDepositToken("TBTCDepositToken", address);
  }
  ...
  approveAndCall(
    ...
    let result = super.call(
      ...
      [
        ...
        ethereum.Value.fromUnsignedBigInt(_tdtId),
...
export class ConstructorCall__Inputs {
  ...
  get _depositFactoryAddress(): Address {
